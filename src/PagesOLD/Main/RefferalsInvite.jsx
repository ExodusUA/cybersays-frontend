...
function RefferalsInvite() {
    return (
        <div className=' absolute top-0 z-30 max-w-[770px] w-full'>
            ...
            <div className='p-5 rounded-[12px] bg-black    border-[1px] border-[#FF1CBB] flex'>
                <div className='w-[20%]  mt-5 mr-3'>
                    ...
                    <p className='saira text-[24px]'>09:53</p>
                </div>
...
export default RefferalsInvite