...
function AuthError({error}) {
    return (
        <div className='w-screen h-screen bg-modal fixed left-0 top-0 z-[99] bg-cover flex items-center justify-center'>
            {
                error && <div className='p-10 rounded-[12px] bg-[#83869b] bg-opacity-25   border-[1px] border-[#FF1CBB] max-w-[400px] w-full'>
                <p className='py-8 text-[24px] font-bold max-w-[500px] w-full text-center'>Authorization Error</p>
                <Link to='/'>
