...
function Main({ languageData }) {
  ...
  useEffect(() => {
    if (userData && userCountry) {
      ...
      let link = `https://cybersaysm.vercel.app?QueryID=197&WID=${linkData.CybersaysWid}&linkID=701&from=freevideo6&cbname=CyberSays&c=${linkData.CultureCode}&promocode=${userData?.id}&task=${
