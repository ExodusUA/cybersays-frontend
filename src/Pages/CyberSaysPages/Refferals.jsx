            ...
            <div className='pt-[60px]  md:pt-[90px] px-4 max-w-[1170px] m-auto' >
                ...
                <div className=' flex justify-center'>
                    <div className='bg-[#EAEAEA] bg-opacity-20 backdrop-blur-lg rounded-[50px] text-center max-w-[800px] w-full py-1 px-2'>
                        <p className='text-[14px]  sm:text-[24px]  font-semibold max-w-[540px] m-auto seMax:leading-[16px]'>“Share with your friends to be the kind
                ...
                <p className='text-[14px] sm:text-[24px] font-semibold text-center text-[#FFED63] seMax:my-1 my-3 mx-14 sm:mx-0 seMax:leading-[16px]'>Choose text and image or keep it simple and without</p>
                        ...
                        {dataMessage.map((item, index) => (
                            <SwiperSlide>
                                <div key={index} onClick={e => setSelectedMassege(index)}
                                    className={`${selectedMessage === index && 'border-[2px] !border-[#FFED63]'} flex justify-between items-center seMax:p-1 p-2 rounded-[50px] border-[2px] border-white cursor-pointer max-w-[220px] w-full`} >
                ...
                <p className='text-[14px] sm:text-[24px] font-semibold text-center text-[#FFED63] seMax:my-1 my-3 '>Chosse an image</p>
                ...
                <p className='text-center text-[12px] sm:text-[14px] saira font-semibold underline mt-2 seMax:mb-2 mb-5'>Choose personalize experience</p>
                <div className='flex justify-center'>
                    <button onClick={e => shareRefferalLink()} className='w-full bg-white  border-[2px] border-[#FFED63] rounded-[50px] text-black text-[18px] saira font-semibold seMax:py-1 py-2 sm:max-w-[350px]'>Share Referral Link!</button>
                </div>
