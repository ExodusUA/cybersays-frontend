...
function Homepage({ user, imLiveURL }) {
    ...
    const getButtonMarkup = (task) => {
        switch (task) {
            case 0: return <Link to={imLiveURL}><button className='w-full sm:w-[350px] bg-white  border-[2px] border-[#FFED63] rounded-[50px] text-black text-[16px] mod:text-[18px] saira font-semibold seMax:py-[6px] py-2 md:py-3'>Double your money 🤑</button></Link>
            case 1: return <button className='w-full sm:w-[350px]  bg-white  border-[2px] border-[#FFED63] rounded-[50px] text-black text-[16px] mod:text-[18px] saira font-semibold py-2 seMax:py-[6px] md:py-3'>2/4: Deposit for 200% Cashback 🤑</button>
            case 2: return <button className='w-full  sm:w-[350px] bg-white  border-[2px] border-[#FFED63] rounded-[50px] text-black text-[16px] mod:text-[18px] saira font-semibold py-2 seMax:py-[6px] md:py-3'>3/4: Spend for 200% Cashback 🤑</button>
            case 3: return <button className='w-full sm:w-[350px] bg-white  border-[2px] border-[#FFED63] rounded-[50px] text-black text-[16px] mod:text-[18px] saira font-semibold py-2 seMax:py-[6px] md:py-3'>Win the Vegas Weekend 💃</button>
        }
    }
    ...
    return (
        <div className=' w-screen h-screen bg-[url(./images/CyberSaysPage/mobile-bg-homepage.jpg)] md:bg-[url(./images/CyberSaysPage/bg-homepage.jpg)] bg-cover bg-no-repeat bg-center relative z-10'>
            <div className='pt-[60px] md:pt-[90px] px-4 pb-12 max-w-[1170px] m-auto'>
                <img className='seMax:w-[230px] seMax:mb-[-5px] w-[200px] mob:w-[310px] md:w-[500px] m-auto' src={logoCyber} alt="logoCyber" />
