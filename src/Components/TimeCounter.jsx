...
function TimeCounter({ languageData }) {
    ...
    return (
        <div>
            <p className='text-[18px] lg:text-[32px] mac:!text-[18px] font-semibold iphone:leading-[unset] se:leading-5 md:leading-[unset] mb-[-10px] mac:mb-[-15px] pr-4 text-center'>{languageData?.timeCounterTitle}</p>
