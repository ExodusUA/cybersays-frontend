...
function DoubleComplete({ setOpen, languageData, user,imLiveURL }) {
                ...
                <div className='  max-w-[600px] m-auto '>
                    ...
                    <div className='flex justify-center mx-2'>
                        <button onClick={e => {
                            shareRefferalLink()
                            copyImLiveLink()
                            }} className={` w-full bg-white  border-[2px] ${design === '0' ? ' rounded-[50px] border-[2px] bg-white border-[#FFED63]' : ' rounded-[12px] border-none gradient-homepageBtn'} text-black text-[18px] saira font-semibold py-2 flex justify-center mt-2 lg:mt-4 absolute mx-2`}>
