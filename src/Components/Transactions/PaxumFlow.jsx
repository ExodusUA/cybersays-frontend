...
function PaxumFlow({ languageData }) {
    ...
    return (
        ...
        <div className={` w-full m-auto relative  px-2 rounded-[12px] lg:px-4 mt-2`}>
            ...
            <div className='flex justify-center mt-2 lg:mt-4'>
                <button className={`w-full bg-white  border-[2px]  text-black text-[18px] saira font-semibold py-2 outline-none  ${design === '0' ? '  rounded-[50px] border-[2px] bg-white border-[#FFED63]' : ' rounded-[12px] border-none gradient-homepageBtn'}`}>{languageData?.paxumFlowBtn}</button>
            </div>
