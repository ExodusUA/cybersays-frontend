    ...
    return (
        <div>
            <div className='w-screen h-screen fixed top-0 z-[60] bg-[#1E1E1E] bg-opacity-60 backdrop-blur-md p-4'>
                ...
                <div className='max-h-[320px] overflow-scroll border-b-[2px] border-[#FFED63] max-w-[370px] m-auto'>
                ...
                <p className='text-[12px] font-semibold underline text-center saira cursor-pointer sm:mx-[80px] my-2'>Click to see what payment methods
