...
function Withdraw({ user, setOpen, languageData, userCountry }) {
  ...
  return (
    <div>
      {user?.earned !== 0 && user?.earned > 0 && promoModal && <PartnerPromoModal setPartnerSelected={setPartnerSelected} setOpen={setPromoModal} languageData={languageData} user={user} />}
