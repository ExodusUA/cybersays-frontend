            ...
            <div className=' flex items-end justify-center'>
                {
                    leaderboardData[1] && <div className='mr-[-15px] md:mr-[30px] w-[80px] md:w-[100px]'>
                        ...
                        <img className={`border-[2px] rounded-full w-[80px] h-[80px] object-cover m-auto ${design === '0' ? 'border-[#FFED63]' : 'border-[#A1B3B0]'}`} src={'https://picsum.photos/300/300'} alt="twoSt" />
...

                {
                    leaderboardData[0] && <div className='mb-[20px] relative z-20 w-[120px] md:w-[140px]'>
                        ...
                        <img className={`border-[2px] border-[#FFED63] rounded-full w-[120px] h-[120px] object-cover m-auto ${design === '0' ? 'border-[#FFED63]' : 'border-[#F2BB02]'}`} src={'https://picsum.photos/299/300'} alt="twoSt" />
