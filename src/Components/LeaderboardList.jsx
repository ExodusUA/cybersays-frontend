      ...
      <div className=" flex items-end justify-center">
        {leaderboardData[1] && (
          <div className="mr-[-15px] w-[80px] md:mr-[30px] md:w-[100px]">
            ...
            <p className={`saira text-center text-[14px] font-medium md:text-[16px] ${design === "0" ? "text-[#FFED63]" : "text-[#A1B3B0]"}`}>$6.90</p>
        ...
        {leaderboardData[0] && (
          <div className="relative z-20 mb-[20px] w-[120px] md:w-[140px]">
            ...
            <p className={`saira text-center text-[14px] font-medium text-[#FFED63] md:text-[16px] ${design === "0" ? "text-[#FFED63]" : "text-[#F2BB02]"}`}>$6.90</p>
            <p className="saira text-center text-[14px] font-medium text-[#FFED63] md:text-[14px]">
