...
function NewLanguageButton() {
    ...
    return (
        <div className=' relative'>
            <div>
                <button onClick={() => setLangOpen(!langOpen)} className='bg-[#626161]  border-[2px] border-[#FFED63] rounded-[50px] flex items-center gap-2 px-[20px] py-[10px] '>
            ...
            {langOpen && (
                <div className='mt-0 absolute top-[60px] p-4 border-[2px] border-[#FFED63] bg-white w-[100px] rounded-[12px] py-4 min-w-[50px]  left-0'>
