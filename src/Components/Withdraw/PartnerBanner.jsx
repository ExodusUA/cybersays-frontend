    ...
    <div>
      <div onClick={(e) => selectPayment("Partner")} className=" relative m-auto mb-[5px] mt-2  w-full max-w-[390px] cursor-pointer">
        ...
        <img
          ...
          alt="banner"
        />
        <p className=" saira absolute right-[0px] top-[22px] z-50 w-[140px] text-[8px] font-medium leading-[10px] text-[#A533FF] iphone:right-[15px] iphone:top-[25px] iphone:text-[9px] iphone:leading-[12px]">
          {" "}
        ...
        <img
          className=" absolute top-0 h-full max-h-[170px] min-h-full rounded-b-[10px] rounded-t-[10px]"
