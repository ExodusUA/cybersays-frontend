...
function PaxumFlow({ languageData, setConfirm, setError }) {
    ...
    return (
            ...
            <div className={` w-full relative  px-2 rounded-[12px] lg:px-4  max-w-[600px] m-auto`}>
                ...
                <div className='flex items-center  gap-2 mt-2 lg:mt-4'>
                    ...
                    <label className='saira text-[12px] lg:text-[14px] w-full cursor-pointer select-none font-normal leading-4 my-2' htmlFor="notification">{languageData?.paxumFlowCheckbox} </label>
