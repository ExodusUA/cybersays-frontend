            ...
            <div className='flex justify-center '>
                {
                    data?.taskBlocks?.map((task, key) => {
                        return <div key={key} className='flex  items-center se:mt-1 mt-2 relative '>
                            ...
                            <p className={`saira text-[10px]  text-black font-medium absolute text-left leading-[12px] ${index === 1 ? `${design === '0' ? 'w-[150px] sm:w-[125px] top-[15px] sm:top-[45px] right-[25px] sm:right-[45px]' : 'w-[180px] sm:w-[135px] top-[17px] sm:top-[45px] right-[15px] sm:right-[25px] text-white text-[14px] leading-[16px]'}` :
                                index === 2 ? `${design === '0' ? 'w-[140px] sm:w-[100px]  top-[15px] sm:top-[15px] left-[35px] sm:left-[40px]' : 'w-[200px] sm:w-[140px] top-[20px] sm:top-[35px] left-[30px] sm:left-[25px] text-white text-[14px] leading-[16px]'}` :
                                    index === 3 ? `${design === '0' ? 'w-[160px] sm:w-[110px] top-[15px] sm:top-[25px] right-[35px] sm:right-[25px]' : 'w-[205px] sm:w-[160px] top-[18px] sm:top-[32px] right-[35px] sm:right-[20px] text-white text-[14px] leading-[16px]'}` :
