function CustomTooltip({ open, setOpen, children }) {
    return (
        <div className={`fixed min-w-[370px] top-[50px] right-0 bg-white p-4 rounded-[22px] duration-300 z-[999999999999] ${open === true ? 'opacity-100 pointer-events-auto' : 'opacity-0 pointer-events-none'}`}>
