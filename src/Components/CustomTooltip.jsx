function CustomTooltip({ open, setOpen, children }) {
    return (
        <div className={`absolute max-w-[370px] md:max-w-[unset] w-full top-[110px] right-0 bg-white p-4 rounded-[22px] duration-300 z-[999] ${open === true ? 'opacity-100 pointer-events-auto' : 'opacity-0 pointer-events-none'}`}>
