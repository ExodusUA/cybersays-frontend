...
function GoogleButton({ loginViaGoogle, languageData }) {
    ...
    return (
        <>
            ...
            <button onClick={() => googleLogin()} type="button" className='w-[50%] lg:w-full gap-2 lg:gap-4  flex bg-[#1E1E1E] px-2 lg:px-3 py-2  rounded-[8px] lg:rounded-[12px] items-center justify-center'>
